export async function populateDevices(
    ...
    const audioSelect = settingsModal.querySelector("#audioDeviceSelect") as HTMLSelectElement;
    const videoSelect = settingsModal.querySelector("#videoDeviceSelect") as HTMLSelectElement;
    const speakerSelect = settingsModal.querySelector("#speakerDeviceSelect") as HTMLSelectElement;
    ...
    return { selectedAudioDeviceId, selectedVideoDeviceId, selectedSpeakerDeviceId };
}
